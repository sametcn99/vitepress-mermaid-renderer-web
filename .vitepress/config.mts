...
export default defineConfig({
	...
	head: [
		...
		[
			...
			{
				name: "og:description",
				content: "A VitePress plugin to render Mermaid diagrams with interactive controls",
			},
		],
	...
	themeConfig: {
		...
		editLink: {
			pattern: "https://github.com/sametcn99/vitepress-mermaid-renderer/edit/main/test-project/:path",
